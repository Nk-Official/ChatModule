...
extension ContactsPrefrences {
    ...
    init() {
        ...
        showMuteOption = true
        showDate = true
        dateColor = UIColor(displayP3Red: 126/255, green: 126/255, blue: 125/255, alpha: 1)
        dateFont = UIFont.systemFont(ofSize: 12)
        showLastMessage = true
        lastMessageColor = UIColor(displayP3Red: 126/255, green: 126/255, blue: 125/255, alpha: 1)
        lastMessageFont = UIFont.systemFont(ofSize: 12)
        showName = true
        nameColor = UIColor.black
        nameFont = UIFont.systemFont(ofSize: 15, weight: .heavy)
        showUnreadMessagesCount = true
        unreadMessageCountColor = UIColor.white
        unreadMessageCountFont = UIFont.boldSystemFont(ofSize: 12)
